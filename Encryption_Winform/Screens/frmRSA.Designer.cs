...
partial class frmRSA
{
    ...
    private void InitializeComponent()
    {
        ...
        p = new Guna.UI2.WinForms.Guna2HtmlLabel();
        ...
        q = new Guna.UI2.WinForms.Guna2HtmlLabel();
        txtq = new Guna.UI2.WinForms.Guna2TextBox();
        e = new Guna.UI2.WinForms.Guna2HtmlLabel();
        ...
        groupBox1.Location = new Point(704, 41);
        ...
        p.Font = new Font("Segoe UI Variable Text", 10.8F, FontStyle.Bold, GraphicsUnit.Point, 0);
        p.ForeColor = Color.FromArgb(255, 240, 255);
        p.Location = new Point(77, 123);
        p.Name = "p";
        p.Size = new Size(19, 26);
        p.TabIndex = 17;
        p.Text = "p:";
        // 
        // txtKey
        ...
        txtKey.Location = new Point(126, 123);
        ...
        txtKey.Size = new Size(104, 32);
        txtKey.TabIndex = 16;
        txtKey.KeyPress += txtNumber_KeyPress;
        txtKey.Validating += txtp_Validating;
        // 
        // lblSource
        // 
        ...
        lblSource.Location = new Point(11, 52);
        lblSource.Name = "lblSource";
        lblSource.Size = new Size(93, 26);
        lblSource.TabIndex = 15;
        ...
        txtSource.Location = new Point(126, 52);
        ...
        btnRests.CustomizableEdges = customizableEdges5;
        ...
        btnRests.Location = new Point(722, 177);
        btnRests.Name = "btnRests";
        btnRests.ShadowDecoration.CustomizableEdges = customizableEdges6;
        btnRests.Size = new Size(168, 35);
        btnRests.TabIndex = 22;
        btnRests.Text = "Rest";
        ...
        lblResult.Location = new Point(11, 354);
        ...
        txtResult.Location = new Point(126, 354);
        ...
        btnTask.Location = new Point(722, 454);
        ...
        q.Font = new Font("Segoe UI Variable Text", 10.8F, FontStyle.Bold, GraphicsUnit.Point, 0);
        q.ForeColor = Color.FromArgb(255, 240, 255);
        q.Location = new Point(245, 123);
        q.Name = "q";
        q.Size = new Size(19, 26);
        q.TabIndex = 24;
        q.Text = "q:";
        // 
        // txtq
        // 
        txtq.BackColor = Color.FromArgb(60, 60, 60);
        txtq.BorderColor = Color.FromArgb(0, 55, 78);
        txtq.CustomizableEdges = customizableEdges13;
        txtq.DefaultText = "";
        ...
        txtq.FillColor = Color.FromArgb(32, 32, 32);
        ...
        txtq.Location = new Point(270, 123);
        txtq.Margin = new Padding(3, 4, 3, 4);
        txtq.Name = "txtq";
        txtq.PasswordChar = '\0';
        txtq.PlaceholderText = "";
        txtq.SelectedText = "";
        txtq.ShadowDecoration.CustomizableEdges = customizableEdges14;
        txtq.Size = new Size(104, 32);
        txtq.TabIndex = 23;
        txtq.KeyPress += txtNumber_KeyPress;
        txtq.Validating += txtq_Validating;
        // 
        // e
        // 
        e.BackColor = Color.Transparent;
        e.Font = new Font("Segoe UI Variable Text", 10.8F, FontStyle.Bold, GraphicsUnit.Point, 0);
        e.ForeColor = Color.FromArgb(255, 240, 255);
        e.Location = new Point(390, 123);
        e.Name = "e";
        e.Size = new Size(18, 26);
        e.TabIndex = 26;
        e.Text = "e:";
        // 
        // txte
        // 
        txte.BackColor = Color.FromArgb(60, 60, 60);
        txte.BorderColor = Color.FromArgb(0, 55, 78);
        txte.CustomizableEdges = customizableEdges11;
        txte.DefaultText = "";
        ...
        txte.FillColor = Color.FromArgb(32, 32, 32);
        ...
        txte.Location = new Point(415, 123);
        txte.Margin = new Padding(3, 4, 3, 4);
        txte.Name = "txte";
        txte.PasswordChar = '\0';
        txte.PlaceholderText = "";
        txte.SelectedText = "";
        txte.ShadowDecoration.CustomizableEdges = customizableEdges12;
        txte.Size = new Size(104, 32);
        txte.TabIndex = 25;
        txte.KeyPress += txtNumber_KeyPress;
        txte.Validating += txtE_Validating;
        // 
        // frmRSA
        // 
    ...
    private Guna.UI2.WinForms.Guna2HtmlLabel p;
    ...
    private Guna.UI2.WinForms.Guna2HtmlLabel e;
    private Guna.UI2.WinForms.Guna2TextBox txte;
    private Guna.UI2.WinForms.Guna2HtmlLabel q;
